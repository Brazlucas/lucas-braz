      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.a
            ...
            className="flex flex-col items-center p-8 bg-dark-200 rounded-2xl hover:bg-dark-100 transition-colors cursor-pointer group"
          >
            ...
            <p className="text-primary-200/70">(11) 96518-9569</p>
          </motion.a>
          ...
          <motion.a
            ...
            className="flex flex-col items-center p-8 bg-dark-200 rounded-2xl hover:bg-dark-100 transition-colors cursor-pointer group"
          >
            <div className="p-4 bg-accent-500/10 rounded-full mb-4 group-hover:bg-accent-500/20 transition-colors">
              <Mail className="w-8 h-8 text-accent-400" />
            </div>
            <h3 className="text-lg font-semibold text-white mb-2">Email</h3>
            <p className="text-primary-200/70">lukkascomics@gmail.com</p>
          </motion.a>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="flex gap-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-3 bg-dark-100 rounded-full hover:bg-dark-50 transition-colors text-white"
              >
        ...
        <footer className="mt-20 text-primary-300/50 text-sm">
