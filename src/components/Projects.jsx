...
import { ExternalLink, ShoppingBag, Terminal, Waves } from 'lucide-react';
  ...
  return (
    <section id="projects" className="py-20 px-8 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {/* Simulador de Surf Project */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.1 }}
          className="group relative bg-[#111111] rounded-2xl overflow-hidden border border-zinc-800 hover:border-[#FFD600]/50 hover:shadow-[0_0_30px_rgba(255,214,0,0.1)] transition-all hover:-translate-y-1"
        >
          ...
          <div className="relative z-20 p-8 h-full flex flex-col justify-end min-h-[300px]">
            <div className="mb-4">
              <div className="p-3 bg-[#FFD600]/10 w-fit rounded-xl mb-4 backdrop-blur-sm group-hover:bg-[#FFD600] transition-colors duration-300">
                <Waves className="w-6 h-6 text-[#FFD600] group-hover:text-black transition-colors duration-300" />
              </div>
              <h3 className="text-2xl font-bold tracking-tight text-white mb-2 group-hover:text-[#FFD600] transition-colors">Simulador de Surf</h3>
              <p className="text-zinc-400 mb-4 transition-colors duration-300 group-hover:text-zinc-300">
                {translations.projects.simuladorDesc}
              </p>
            </div>

            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-[#FFD600]/5 text-[#FFD600] rounded-full text-sm border border-[#FFD600]/20">React</span>
              <span className="px-3 py-1 bg-[#FFD600]/5 text-[#FFD600] rounded-full text-sm border border-[#FFD600]/20">Landing Page</span>
              <span className="px-3 py-1 bg-[#FFD600]/5 text-[#FFD600] rounded-full text-sm border border-[#FFD600]/20">Vite</span>
            </div>

            <a
              href="https://www.simuladordesurf.com.br"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[#FFD600] hover:text-[#E8C200] font-medium transition-colors"
            >
